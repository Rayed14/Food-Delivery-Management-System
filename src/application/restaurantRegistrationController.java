...
public class restaurantRegistrationController {
    ...
    void restaurantLoginPage(ActionEvent event) throws IOException {
    	if(restaurantName.getText().isEmpty() || restaurantPhNumber.getText().isEmpty() || restaurantEmail.getText().isEmpty() || restaurantAddress.getText().isEmpty() || restaurantUsername.getText().isEmpty() || restaurantPassword.getText().isEmpty())
    	{
